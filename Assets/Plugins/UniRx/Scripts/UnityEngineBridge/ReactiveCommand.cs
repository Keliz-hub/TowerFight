            ...
            if (canExecute.Value)
            {
                ...
                if (a.Length == 1)
                {
                    try
                    {
                        ...
                        return asyncState.Finally(() => canExecuteSource.Value = true).Subscribe(parameter);
                    }
                    catch
                    {
                ...
                else
                {
                    ...
                    return Observable.WhenAll(xs).Finally(() => canExecuteSource.Value = true).Subscribe(parameter);
                }
            }
            else
            {
